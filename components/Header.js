  ...
  return (
    <header className='fixed top-0 w-full bg-white z-50 shadow-xl'>
      <nav className='container mx-auto py-2 px-4 flex justify-between items-center'>
        ...
        <button className='sm:text-lg text-base px-3 sm:px-4 py-2 sm:py-2.5 text-white bg-[#b82d24] font-bold hover:bg-white border-4 border-[#b82d24] transition-all duration-150 hover:text-[#b82d24]'>
          <a
